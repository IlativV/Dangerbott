...
async def on_message(message):
    ...
    if message.content.lower().startswith('!commands'):
        await
        client.send_message(message.channel,
                            "Hier ist eine Liste aller Commands: https://goo.gl/doSQWH")
    if message.content.lower().startswith('!facebook'):
        await
        client.send_message(message.channel,
                            "Hier ist meine Facebook Seite: https://goo.gl/35VuhR")
    ...
    if message.content.lower().startswith('!server'):
        await
        client.send_message(message.channel,
                            "Auf diesem Minecraft Server spiele ich gerade: https://unicacity.de Auf dem Server kommst du mit der 1.12 Version der Java Edition.")
    ...
    if message.content.lower().startswith('!trinkgeld'):
        await
        client.send_message(message.channel,
                            "Hier kannst du mir etwas Trinkgeld geben: https://goo.gl/g2N4Vb")
    if message.content.lower().startswith('!twitch'):
        await
        client.send_message(message.channel,
                            "Du schaust Livestreams lieber auf Twitch ? Hier ist der Link : https://goo.gl/5Kbc3m")
    ...
    if message.content.lower().startswith('!youtube'):
        await
        client.send_message(message.channel,
                            "Hier gibt es Videos die dir gefallen könnten : https://goo.gl/8HUkBW")
