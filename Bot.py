...
async def on_message(message):
    if message.content.lower().startswith('!'):
        ...
        if message.channel.id == "474317552936288277":
            ...
            elif message.content.lower().startswith('!einladung'):
                await client.send_message(message.channel,
            ...
            elif message.content.lower().startswith('!instagram'):
                await client.send_message(message.channel,
                                        "Hier ist mein Instagram Account: https://www.instagram.com/dangerzockt")
            elif message.content.lower().startswith('!key'):
                await client.send_message(message.channel,
                                        "Hier kannst du günstige Gamekeys (auf MMOGA) kaufen: https://mmo.ga/Cp8o")
            elif message.content.lower().startswith('!premium'):
                await client.send_message(message.channel,
            ...
            elif message.content.lower().startswith('!server'):
                await client.send_message(message.channel,
            ...
            elif message.content.lower().startswith('!tippspiel'):
                await client.send_message(message.channel,
                                        "Bundesliga Tippspiel 2018/19 - trete der Dangerliga bei! https://dangerliga.webtippspiel.net")
            elif message.content.lower().startswith('!tp'):
                await client.send_message(message.channel,
                                        "Mit diesem Texture Pack spiele ich zurzeit: http://bdcraft.net")
            elif message.content.lower().startswith('!trinkgeld'):
                await client.send_message(message.channel,
                                        "Hier kannst du mir etwas Trinkgeld hinterlassen: https://www.tipeeestream.com/dangerzockt-lp/tip")
            elif message.content.lower().startswith('!twitch'):
                await client.send_message(message.channel,
                                        "Hier ist mein Twitch Kanal: https://www.twitch.tv/dangerzockt")
            elif message.content.lower().startswith('!twitter'):
                await client.send_message(message.channel,
                                        "Hier ist meine Twitter Seite: https://twitter.com/DangerZockt")
            elif message.content.lower().startswith('!uploadplan'):
                await client.send_message(message.channel,
            ...
            if message.content.lower().startswith('!lul'):
                await client.send_message(message.channel,
                                        "**jaja! Ich bin da.**")
            elif message.content.lower().startswith('!abo'):
                await client.send_message(message.channel,
                                        "*Noch kein Abonnent? Hier kannst du mich abonnieren: https://goo.gl/kHwHVN*")
            elif message.content.lower().startswith('!einladung'):
                await client.send_message(message.channel,
    ...
    if message.channel.id == "478560342553788427" or "474317552936288277":
